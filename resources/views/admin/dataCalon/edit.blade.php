                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <a href="/dataCalonKomandanResimen"><button type="button" class="btn-close"
                                    data-bs-dismiss="modal" aria-label="Close"></button></a>
                        </div>
                        <div class="modal-body">
                            <form action="{{ url('/dataKandidatKomandanResimen/edit/' . $dataKandidat->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="input-icon mb-3">
                                            ...
                                            <input type="number" value="{{ $dataKandidat->no_urut }}" id="no_urut"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="input-icon mb-3">
                                            ...
                                            <input type="text" value="{{ $dataKandidat->nama_calon }}" id="nama"
                                    ...
                                    <div class="col-12">
                                        <div class="mb-3">
                                            ...
                                            <div class="input-icon mb-3">
                                                ...
                                                <textarea id="keterangan" name="keterangan" class="form-control" style="resize: vertical;">{!! $dataKandidat->keterangan !!}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
