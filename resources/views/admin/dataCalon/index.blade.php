            ...
            <div class="row mt-2">
                <div class="col-3">
                    <div class="card" style="background-color: #1A5F7A">
                        <div class="card-body">
                            <p class="text-center text-white "><strong>Data Kandidat Komandan Resimen</strong></p>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <tbody class="table-tbody">
                                        @foreach ($dataCalon as $item)
                                            <tr>
                                                ...
                                                <td><a href="{{ url('asset/kandidat/' . $item->foto_calon) }}"
                                                        target="_blank">
                                                        <img
                                                            src="{{ url('asset/kandidat/' . $item->foto_calon) }}"alt="{{ $item->foto_calon }}">
                                                    </a></td>
                                                <td>{!! $item->keterangan !!}</td>
                                                <td>
                                                    <a href="/dataKandidatKomandanResimen/edit/{{ $item->id }}"
                                                    ...
                                                    <form method="POST"
                                                        action="/dataKandidatKomandanResimen/{{ $item->id }}/delete"
                                                        class="mt-2">
                                                        @csrf
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Data Kandidat Komandan Resimen</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="/kandidatKomandanResimen-add" method="POST" id="form_departemen"
