            ...
            <div class="row mt-2">
                <div class="col-3">
                    <div class="card" style="background-color: #1A5F7A">
                        <div class="card-body">
                            <p class="text-center text-white "><strong>Data Kandidat Ketua Demustar</strong></p>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="card-body">
                            ...
                            <div id="table-default" class="table-responsive">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th><button class="table-sort" data-sort="sort-name">No Urut</button>
                                            </th>
                                            <th><button class="table-sort" data-sort="sort-city">Nama Kandidat</button></th>
                                            <th><button class="table-sort" data-sort="sort-city">Foto Kandidat</button></th>
                                            <th><button class="table-sort" data-sort="sort-city">Keterangan</button></th>
                                            <th><button class="table-sort" data-sort="sort-city">Aksi</button></th>

                                        </tr>
                                    </thead>
                                    <tbody class="table-tbody">
                                        @foreach ($dataCalon2 as $item)
                                            <tr>
                                                <td>{{ $item->no_urut }}</td>
                                                <td>{{ $item->nama_calon }}</td>
                                                <td><a href="{{ url('asset/kandidat2/' . $item->foto_calon) }}"
                                                        target="_blank">
                                                        <img
                                                            src="{{ url('asset/kandidat2/' . $item->foto_calon) }}"alt="{{ $item->foto_calon }}">
                                                    </a></td>
                                                <td>{!! $item->keterangan !!}</td>
                                                <td>
                                                    <a href="/dataKandidatKetuaDemustar/edit/{{ $item->id }}"
                                                    ...
                                                    <form method="POST"
                                                        action="/dataKandidatKetuaDemustar/{{ $item->id }}/delete"
                                                        class="mt-2">
                                                        @csrf
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">Tambah Data Kandidat Ketua Demustar</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="/kandidatKetuaDemustar-add" method="POST" id="form_departemen"
                        enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-12">
                                <div class="form-label">Nomor Urut Paslon</div>
                                ...
                                <div class="input-icon mb-3">
                                    ...
                                    <input type="number" value="" id="no_urut" name="no_urut"
                                        class="form-control">
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    ...
                                    <div class="input-icon mb-3">
                                        ...
                                        <textarea id="keterangan" name="keterangan" class="form-control" placeholder="Keterangan(Visi Misi)"
