                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <a href="/dataPemilih"><button type="button" class="btn-close" data-bs-dismiss="modal"
                                    aria-label="Close"></button></a>
                        </div>
                        <div class="modal-body">
                            <form action="{{ url('/dataPemilih/edit/' . $dataPemilih->id) }}" method="POST"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="input-icon mb-3">
                                            ...
                                            <input type="text" value="{{ $dataPemilih->nama }}" id="nama_dept"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="input-icon mb-3">
                                            ...
                                            <input type="text" value="{{ $dataPemilih->username }}" id="username"
                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="input-icon mb-3">
                                            ...
                                            <input type="text" value="{{ $dataPemilih->kataSandi }}" id="kataSandi"
