                ...
                <div class="card card-primary card-outline">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <a href="{{ url('asset/kandidat2/' . $item->foto_calon) }}" target="_blank">
                                <img src="{{ url('asset/kandidat2/' . $item->foto_calon) }}" alt="{{ $item->foto_calon }}"
                                    class="card-img">
                            </a>
                        </div>
                        ...
                        <center>
                            <a href="/detailDataKandidatKetua/{{ $item->id }}" class="btn btn-success btn-sm">
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <a href="/dashboard/pemilihKetua"><button type="button" class="btn-close"
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="text-center">
                                    <a href="{{ url('asset/kandidat2/' . $detailDataKandidat->foto_calon) }}"
                                        target="_blank">
                                        <img
                                            src="{{ url('asset/kandidat2/' . $detailDataKandidat->foto_calon) }}"alt="{{ $detailDataKandidat->foto_calon }}">
                                    </a>
                                </div>
                            </div>
                            <div class="row">
