...
@section('content')
    ...
    @if (auth()->user()->status_vote_komandan == 1)
    ...
    @else
        ...
        <div class="row justify-content-center">
            @foreach ($dataCalonKomandan as $item)
                    ...
                    <div class="card card-primary card-outline h-100 d-flex flex-column"
                        ...
                        <div class="card-body d-flex flex-column"
                            ...
                            <div class="row">
                                <div class="text-center">
                                    <img style="width: auto; height: 419px"
                                        src="{{ url('asset/kandidat/' . $item->foto_calon) }}"
                                        alt="{{ $item->foto_calon }}">
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div style="margin-top: auto;">
                                <center>
                                    <a href="/pilihKandidatKomandan/{{ $item->id }}" class="btn btn-primary">
